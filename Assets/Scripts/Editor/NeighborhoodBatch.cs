...
public static class NeighborhoodBatch {
 ...
 public static void Apply(){
  ...
  foreach(string name in new[]{"Original house 2"}){var t=GameObject.Find(name).transform;for(int i=0;i<3;i++)Fence(name+" side fence "+i,t.TransformPoint(new Vector3(-19,0,-5+i*4.2f)),t.rotation*Quaternion.Euler(0,90,0));}
