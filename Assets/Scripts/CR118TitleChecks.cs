...
namespace Racer
{
    public sealed partial class CR112Validation
    {
        ...
        IEnumerator TitleOutput()
        {
            ...
            else {yield return new WaitForSecondsRealtime(.65f);Check(title&&title.Theme.isPlaying&&title.Theme.loop&&title.VoiceStarts==1&&flow.State==RaceFlow.Stage.Title,"Untouched startup reaches looping title theme after the full voice");}
