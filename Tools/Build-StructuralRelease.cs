...
public static class BuildStructuralRelease {
 public const string Version="0.27.0-review1";
 ...
 public static string Main(){
  ...
  var scenes=ReverseReviewRelease.Scenes.Concat(new[]{"Assets/Scenes/MountainLoop.unity","Assets/Scenes/MountainLoopReverse.unity"}).ToArray();
  ...
  File.WriteAllText("Docs/SimpleLaurel/build-release.txt",report);if(result.summary.result!=BuildResult.Succeeded)throw new Exception(report);
