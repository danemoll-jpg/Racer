param([ValidatePattern('^[0-9]+\.[0-9]+\.[0-9]+(?:-[A-Za-z0-9-]+)?$')][string]$Version='0.25.0-review1')
$ErrorActionPreference='Stop'
$reviewDocs=if($Version -like '0.25.0-*'){ 'LocalRecovery' }elseif($Version -like '0.24.1-*'){ 'MountainMenu' }elseif($Version -like '0.24.0-*'){ 'CR133-137' }elseif($Version -like '0.23.0-*'){ 'CR129-132' }elseif($Version -like '0.22.0-*'){ 'CR122-128' }elseif($Version -like '0.21.1-*'){ 'CR121-followup' }elseif($Version -like '0.20.1-*'){ 'CR120-121' }else{ 'CR112-118' }
$isCurrentReview=$Version -like '0.25.0-*' -or $Version -like '0.24.1-*' -or $Version -like '0.24.0-*' -or $Version -like '0.23.0-*' -or $Version -like '0.20.*' -or $Version -like '0.21.1-*' -or $Version -like '0.22.0-*'
...
# Approved title artwork is a permanent portable cover asset for every release.
$coverSource=Join-Path $projectRoot 'Assets/Resources/Title/Artwork.png'
$coverTarget=Join-Path $stage 'WoodstockRush-Cover.png'
...
if((Get-FileHash -LiteralPath $coverSource).Hash -ne (Get-FileHash -LiteralPath $coverTarget).Hash){throw 'Approved cover artwork verification failed'}
...
if($isCurrentReview){Copy-Item -LiteralPath "$projectRoot/Docs/$reviewDocs/README-player.txt" -Destination "$stage/README.txt"}elseif($Version -like "0.19.0-*"){Copy-Item -LiteralPath "$projectRoot/Docs/CR105-111/README-player.txt" -Destination "$stage/README.txt"}elseif($Version -like "0.18.0-*"){Copy-Item -LiteralPath "$projectRoot/Docs/CR101-104/README-player.txt" -Destination "$stage/README.txt"}elseif($Version -like "0.17.0-*"){Copy-Item -LiteralPath "$projectRoot/Docs/CR097-100/README-player.txt" -Destination "$stage/README.txt"}elseif($Version -like "0.16.0-*"){Copy-Item -LiteralPath "$projectRoot/Docs/CR091-096/README-player.txt" -Destination "$stage/README.txt"}elseif($Version -like "0.15.0-*"){Copy-Item -LiteralPath "$projectRoot/Docs/CR081-090/README-player.txt" -Destination "$stage/README.txt"}elseif($Version -like "0.14.0-*"){Copy-Item -LiteralPath "$projectRoot/Docs/CR082-089/README-player.txt" -Destination "$stage/README.txt"}elseif($Version -like "0.13.0-*"){Copy-Item -LiteralPath "$projectRoot/Docs/CR075-080/README-player.txt" -Destination "$stage/README.txt"}elseif($Version -eq "0.12.0-review1"){Copy-Item -LiteralPath "$projectRoot/Docs/CR070-074/README-player.txt" -Destination "$stage/README.txt"}elseif($Version -eq "0.11.0-review1"){Copy-Item -LiteralPath "$projectRoot/Docs/CR067-069/README-player.txt" -Destination "$stage/README.txt"}elseif($Version -eq "0.10.0-review1"){Copy-Item -LiteralPath "$projectRoot/Docs/CR064-066/README-player.txt" -Destination "$stage/README.txt"}else{(Get-Content -LiteralPath "$projectRoot/Docs/CR061-062/README-player.txt" -Raw).Replace("0.9.1-review1",$Version) | Set-Content -LiteralPath "$stage/README.txt"}
if($isCurrentReview){Copy-Item -LiteralPath "$projectRoot/Docs/$reviewDocs/VALIDATION.md" -Destination "$stage/VALIDATION.md" -Force}elseif($Version -like "0.19.0-*"){Copy-Item -LiteralPath "$projectRoot/Docs/CR105-111/VALIDATION.md" -Destination "$stage/VALIDATION.md" -Force}elseif($Version -like "0.18.0-*"){Copy-Item -LiteralPath "$projectRoot/Docs/CR101-104/VALIDATION.md" -Destination "$stage/VALIDATION.md" -Force}elseif($Version -like "0.17.0-*"){Copy-Item -LiteralPath "$projectRoot/Docs/CR097-100/VALIDATION.md" -Destination "$stage/VALIDATION.md" -Force}elseif($Version -like "0.16.0-*"){Copy-Item -LiteralPath "$projectRoot/Docs/CR091-096/VALIDATION.md" -Destination "$stage/VALIDATION.md" -Force}
...
if($isCurrentReview -or $Version -like "0.19.0-*" -or $Version -like "0.18.0-*" -or $Version -like "0.17.0-*" -or $Version -like "0.16.0-*" -or $Version -like "0.15.0-*" -or $Version -like "0.14.0-*" -or $Version -like "0.13.0-*" -or $Version -in @("0.10.0-review1","0.11.0-review1","0.12.0-review1")){Copy-Item -LiteralPath "$projectRoot/Docs/CR064-066/VEHICLE-ASSET-NOTICES.txt" -Destination $licenses -Force}else{Copy-Item -LiteralPath "$projectRoot/Docs/CR028-033/VEHICLE-ASSET-NOTICES.txt" -Destination $licenses -Force}
