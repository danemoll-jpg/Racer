param([ValidatePattern('^[0-9]+\.[0-9]+\.[0-9]+(?:-[A-Za-z0-9-]+)?$')][string]$Version='0.9.0-review1')
...
(Get-Content -LiteralPath "$projectRoot/Docs/CR057-060/README-player.txt" -Raw).Replace("0.9.0-review1",$Version) | Set-Content -LiteralPath "$stage/README.txt"
