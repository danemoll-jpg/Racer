...
$arguments="-racerSkipTitle -batchmode -screen-width 1280 -screen-height 720 -racerTestSave `"$save`" -evidence `"$evidence`" -logFile `"$project/Logs/cr112-$Tag-$Name.log`" $Flags"
