$before=(git show 'fcd82ea:Assets/Scenes/StreetLoopGreybox.unity') -join "`n"
...
$report=@("Baseline fcd82ea; retained scene records changed: $changed; removed: $removed",'Changed retained records grouped by object name:')
...
$report | Set-Content Docs/CR014/scene-preservation.txt
