...
System.IO.File.WriteAllText("Docs/Phase6Environment/reentry-routes.json",UnityEngine.JsonUtility.ToJson(plan,true));
var b=Racer.WoodlandBenchmark.Begin("Docs/Phase6Environment/reentry-routes.json","Docs/Phase6Environment/reentry.csv");b.repeats=1;
