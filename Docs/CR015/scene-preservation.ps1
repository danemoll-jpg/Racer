$before=(git show 'a1212ec:Assets/Scenes/StreetLoopGreybox.unity') -join "`n"
...
$report=@("Baseline a1212ec; retained scene records changed: $changed; removed: $removed",'Changed retained records grouped by object name:')
...
$report | Set-Content Docs/CR015/scene-preservation.txt
