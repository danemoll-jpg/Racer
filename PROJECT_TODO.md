...
**Consistent testing entry point:** Dan launches `Play-Racer.cmd` at the project root, or `Builds/Latest/Racer.exe`. After each new validated playable build, update the complete `Builds/Latest` runtime folder (including VERSION.txt); never replace only its executable. Keep older versioned builds separately. Current Latest is 0.3.0-review1, source de84d067cb14773d08309cf697037aca30522fac. A source commit alone does not update a compiled player.
...
**Status:** IMPLEMENTED — integrated validation in progress; awaiting Dan's approval with CR-027.
...
**Result:** Visible forward grid, Easy/Normal/Hard driver judgment, three car opponents and same-capability car profiles implemented. Initial AI series: 9/9 finishes, zero AI misses/recoveries; Normal automated player DNF retained and finish-area runoff revised. See Docs/CR026-027/VALIDATION.md for final evidence and review limitations.

### CR-027 — Vehicle garage with cars, motorcycle and four-wheeler
**Status:** IMPLEMENTED — four profiles and garage integrated; validation in progress, awaiting Dan's approval with CR-026.
...
**Result:** Four stable profiles, pre-race garage/preview, persistent selection, profile/rules/mode/difficulty records, wheels/lean, class contact rules and per-vehicle camera/audio defaults implemented. Flat speed/response comparisons and 60-case contact matrix pass; ordinary-frame and Windows review evidence in Docs/CR026-027/VALIDATION.md.
