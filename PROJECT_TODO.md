...
**Status:** IMPLEMENTED in 0.18.0-review1 / AWAITING DAN REVIEW. Drawing 2026-09-20 22_43_54-C__Users_danmo_Racer and 1 more tab - File Explorer.png in Downloads supersedes earlier inferred layout.
...
**Outcome:** Garage visual geometry and colliders moved across Driveway 1; small pool house beside pool; local terrain/fence closure adjusted. Compiled top-down and driveway-side views inspected; changed driveway traversal passed. No neighborhood/race acceptance inferred.

### CR-102 — Summit sign overflow and wrong-facing boards
**Status:** IMPLEMENTED in 0.18.0-review1 / AWAITING DAN REVIEW. Three 2026-09-20 Racer screenshots (22_30_11, 22_29_30, 22_29_06) show oversized out-of-board mirrored lettering and inaccessible facing direction.
...
**Outcome:** All five summit boards use fitted 7 x 2.3 m faces and dedicated front-only text. All ten compiled approach/rear captures inspected. Shared signage unchanged.

### CR-103 — Usable giant jump completely clears mountain toward Dan's house
**Status:** REBUILT in 0.18.0-review1 / AWAITING DAN REVIEW; local jump award remains zero. Dan reports wrong heading, insufficient straight run-up, approach pit and failure to clear mountain. Prior scripted airtime/crest claims do not establish human-requested trajectory.
...
**Outcome:** House-derived homeward heading; 215 m horizontal / 221.795 m surface run-up from rest; normal-input speeds 36.44-42.84 m/s. Both lines per profile cleared the mountain and reached the catch slope. Failed connector/return repaired and passed. Final motorcycle/ATV passed. Original-car first-contact alignment diagnostic and follow-up are documented in Docs/CR101-104/VALIDATION.md. Single aborted reset and moved map/activity coordinates passed. Existing award remains zero; no scoring threshold changes. Baseline approach did not reproduce reported pit and did not include flight; no second baseline claimed.

### CR-104 — Spoken title cuts off 'Rush'
**Status:** IMPLEMENTED in 0.18.0-review1 / OUTPUT VERIFIED; subjective listening pending.
...
**Outcome:** Dan confirms complete source word. Source/import preserve all 84,010 frames. Old output tail was nearly equal to background mix. Voice now completes plus 200 ms before theme starts. No-input DSP capture preserves tail; virtual-button skip advances once; radio starts at menu; temporary audio remuted. No subjective listening or physical-controller/Deck validation claimed. Saved preferences and shipped volume settings are unchanged.
...
Current pass CR-105–111 ONLY: the explicitly listed road/junction, three-mailbox, lap/playlist, confirmation, new-mountain and turkey cases below; complete packaging and one portable startup. No ghosts, old-course races, broad records/map/collectibles/wildlife, difficulty/seed matrices or unrelated audio checks. Preserve unreviewed statuses and old failure evidence without spending time reopening them. Package once specified checks pass. This user preference supersedes earlier broad-test requirements for this pass.
...
**Status:** IMPLEMENTED / TARGETED VERIFIED in 0.19.0-review3; new HUMAN review pending. See Docs/CR105-111/VALIDATION.md for exact cases and retained failures.
...
Deliver complete Windows runtime/ZIP/Latest, preserve prior builds and staged music, verify package identity and one extracted startup. Include the approved title artwork as WoodstockRush-Cover.png beside Racer.exe in every future release and ZIP; verify inclusion without additional gameplay tests. Update actual outcomes and concise new-feature checklist, safety/completion commits; no external upload or unsupported physical Deck/controller acceptance claims.

---

### CR-112 — Missing household scenes after campsite addition
**Status:** ACCEPTED / VERIFIED by Dan on 2026-09-21.
Current-house placement and ground support were corrected, including smokers buried below the current terrain and complete interfering crowns. Six ordinary street approaches reached coffee (two outside Dan's fence), football (three inside his yard), smokers (two at Kyle's frontage), and empty; the independent two campers remained. Evidence: Docs/CR112-118/final/households. No unrelated ambient-life tests.
...
**Status:** IMPLEMENTED / targeted road drives and final views passed; awaiting Dan review.
Four-lane inner joins and Kyle's driveway-owned frontage wedge repaired; both inner normal drives and the local patch passed. Outer east mesh audit found a 33.7-metre final-quad terrain-fallback drop. Corrected supported continuations and their logical return boundary pass both outer drives. Final screenshots exposed obsolete non-colliding tunnel backdrop panels at station 429; those panels are removed from the six scenes and regeneration recipe. Final player views and short drives passed in Docs/CR112-118/final5/endpoints. Dan's two drives and House 3's repaired drive remain; no physical road-end walls.
...
**Status:** ACCEPTED / TURKEY SIGHTING VERIFIED by Dan on 2026-09-21.
Targeted implementation/checks complete: current Kyle habitats moved onto the visible driveway approach; reset selection now commits before the new world frame instead of waiting indefinitely for a retained group to leave the frustum. A saved two-present/four-absent visit bag keeps appearances occasional. One naturally scheduled visible group of three and one absent visit passed (Docs/CR112-118/final2/turkeys). Turkey audio unchanged; Dan verified the sighting on 2026-09-21.
...
**Status:** IMPLEMENTED / targeted keyboard naming checks passed.
Focused uGUI text entry supports typing, spaces, paste, selection, Backspace/Delete, Enter save/reload and Escape cancellation. Focused text and the close frame suppress menu/gameplay shortcuts. Trimmed nonempty names persist; controller character-picker fallback remains. Five bounded naming checks pass; physical Deck/controller hardware not verified.
...
**Status:** IMPLEMENTED / synthetic scoring and UI checks passed; supersedes prior no-championship restriction.
Implemented with replaceable snapshots, stable identities, every-event pages, cumulative standings and winner banner. Seven model checks and the final-player synthetic three-event fixture pass (20/26/12/6 points; Rival 1 wins), including restart replacement, repeated snapshot and unfinished quit. Actual results reopen passed in the retained forward lap. Synthetic results are not a completed three-race playlist; further race testing is superseded by the reduced preview scope.
...
### CR-117 — Mountain Loop and Reverse redesign ACCEPTED by Dan
**Status:** ACCEPTED by Dan on 2026-09-21: both layouts passable and fun. Only CR-120/121 local cleanup remains.
Redesign implemented for review: two mandatory main-line flights and two optional gold-marked routes per direction, wooded ravine, backed signs, cleared canopy and new v2 layout IDs. Retained evidence includes eight initial centered flight cases, one complete forward motorcycle lap (109.934 seconds), four local alternates and two recoveries. Failed attempts remain documented; a later ATV summit collision was not accepted as a pass. Final summit subgrade correction compiled only. Dan explicitly stopped further mountain/AI testing: former lap/offset/vehicle/AI matrix is superseded. AI and remaining vehicle coverage are unverified; Dan accepted both course layouts as passable and fun on 2026-09-21. See Docs/CR112-118/VALIDATION.md.
...
SUPERSEDED TEST PLAN - reduced preview scope above takes precedence; do not execute this matrix: first-playable geometry; four normal-input main-line player laps (bike/ATV both directions), remaining alternate segments locally, centered+modest-off-center each changed jump/profile reusing lap coverage, one recovery/direction, one AI event/direction shared with playlist runs. Repeat only failed/affected cases; final-player evidence. No old-course/ghost/collectible/map/whole-game suites. Human fun acceptance remains Dan's.
...
Status: REOPENED by Dan after actual listening: speech still clips and theme opening is suspect. Prior listener-output comparisons do not close this report. The supplied MP3 and imported WAV decode identically through the complete 1.750208-second recording. Early title input previously stopped its coroutine and voice source; the persistent source now finishes across the title-to-menu transition, with radio held until the speech tail completes. Original voice, artwork and theme are unchanged. The available audio-input tool cannot audition sound; packaged PCM is identical and both listener-DSP captures retain the full ending (final 350-ms correlation 0.999975). Untouched extracted-ZIP startup retains the theme; early advance reaches the menu without interrupting the phrase. The untouched fixture checked its post-dismissal menu too early and retained a failed assertion; portable title startup passed. These captures cannot substitute for a claimed human/OS-endpoint listen.


## CR-112–118 delivery — 0.20.0-review1
Review preview built with zero errors. Complete versioned Windows runtime, ZIP, Latest, bundled music, licenses, standalone cover and route maps delivered locally; previous build/music preserved. See Docs/CR112-118/DELIVERY.md and package-verification.json. Two title signal captures pass; human listening and one too-early post-dismissal menu assertion remain disclosed. Both mountains await Dan review; AI/remaining vehicle coverage unverified; no further matrix is authorized. Ghosts accepted, turkeys awaiting sighting. Launcher queued after this checkpoint.
...
- [x] Dan explicitly approved publication. Authenticated permission confirmed via supported elevated retry; build-21002 published with 194 asset hashes/sizes verified. Public catalog, actual signed hosted update 21001 to 21002 and muted startup passed; playlist preserved. No credentials printed/shipped. Earlier access-review block resolved by explicit approval.
...
Dan still hears clipped speech and suspects theme onset. Prior tail signal evidence did not close the defect. Add artwork/clip-ready 1.5-second lead-in, protect sample-zero speech/theme attack, cancel unstarted audio on dismissal and preserve already-started speech. Two brief startup checks only; listening limitations explicit. All ordinary checks muted.
Safety checkpoint for this follow-up: 489b220b9ed1352731b8b655471bcf373620bb57 (clean HEAD).

### CR-120/121 screenshot clarification (supersedes generic rebalance)
Dan supplied Downloads/needs barrier.png and confused.png. CR-121 is a branch EXIT/rejoin invitation and obstructed main continuation, not authorization to make the entire shortcut harder. Remove the unshipped chicane interpretation, retain accepted shortcut difficulty, move signs, distinguish merge and emphasize the main route. Only one muted motorcycle approach per changed junction; no alternate/AI/full-lap matrix.




## 0.20.1-review1 feedback delivery
CR-120/121 localized reverse cleanup implemented from Dan's exact screenshots. Wrong-end invitation clarified with merge labeling and teal continuation; obstructing signs moved and grounded; accepted shortcut difficulty retained. Summit right-hand side-cut screened while proper run-up remains. One muted normal-input motorcycle approach per junction passed first attempt; no AI/laps/matrices/alternate runs. CR-118 now has an artwork/clip-ready 1.5-second delay, cancellation before voice start and persistent started speech. Theme's first 240 ms were missing from the existing loop: restored the exact source prefix once, retaining the loop. Two final-player startup/timing/signal checks passed, including original voice start/end and theme onset; human audio acceptance remains OPEN. Portable extracted startup/menu and 451-file identity verification pass. Dan's accepted people/turkeys/mountain layouts remain accepted. Hwy92/naming remain unreviewed by Dan; championship acceptance unreported. Launcher CR-119 continues separately after this checkpoint.


## Latest accepted state and CR-121 / CR-118 follow-up — 0.21.1-review2
This section supersedes older pending-sighting, unaccepted-mountain, merge-location and scheduling-delay wording above; historical delivery notes remain for traceability.
- CR-112 household scenes: accepted by Dan. CR-114 turkeys: sighted/accepted by Dan. Ghosts: accepted; untouched and untested.
- CR-117 both mountain layouts/fun: accepted by Dan. Only the specific reverse guidance/cut below reopened; no overall redesign or lap/AI/vehicle matrix.
- CR-113 Hwy92 and CR-115 keyboard naming: not yet reviewed by Dan. CR-116 championship acceptance unreported. No unrelated checks performed.
- CR-119 native launcher build 21002 is published and verified. Preserve updater, music ownership, settings and published catalog; this follow-up is a separate local review, not an automatic public update.
- Safety checkpoint: clean HEAD `c855e8b5c3e5e910d9cde3033d4a2b8d2f3530d9` verified before project edits.

### CR-121 actual findings and local repair
The delivered 0.20.1 source (also used by launcher 21002) only painted gold at 15/40/65m on the 421m Summit Traverse. Dan's pictured route takes LEFT of the central terrain pillar, downhill, then a hairpin back onto uphill teal toward Gully Flight. Extend gold through the tail and add explicit fork/hairpin guidance. The exact executable Dan ran is not independently known; do not claim this new fix reached his installation.
The previous cleanup incorrectly called the actual Downhill Ridge Cut START a merge and hid its entrance arrows. Relocate its legal entrance from road station 1575.8 to 1510, with the preceding gate at 1480, clear gold entrance signage and a grounded timber separator at the old late left cut. Retain the far rejoin at (747,86,-120), accepted main flights and forward/free-roam geometry. Intended bypass gates remain Summit 2/3 and Ridge 4/5. No general checkpoint logic changed. Reverse layout ID becomes mountain-reverse-v3-clear-junctions; historic layouts retained, ghost logic untouched.
Bounded final-player checks and package evidence are recorded in Docs/CR121-followup/VALIDATION.md. One vehicle only; disclose any local automation failure without repeated pilot tuning.

### CR-118 final bounded voice attempt — supersedes earlier delay fix
Dan requests actual leading silence in the audio. Ship VoicePadded.wav: exactly one second of zero-valued PCM followed by every original Voice.wav sample unchanged. Preserve source MP3/WAV, title artwork, theme opening and loop. Remove the obsolete 1.5-second scheduling delay rather than stacking it. Source preparation is reproducible via Tools/Prepare-TitlePadding.py.
