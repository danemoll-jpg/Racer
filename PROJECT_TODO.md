...
**CURRENT DELIVERY — CR-097–100 / 0.17.0-review1:** Property/driveway repairs, summit guidance/geometry, dome tent/stone cairns and dedicated approved title art/audio are implemented for Dan review. Safety checkpoint `acafa41ce76c410e4b970dbbd7c9cf14e487fc8e`. Launch `Play-Racer.cmd` or `Builds/Latest/Racer.exe`; full ZIP `Builds/Racer-0.17.0-review1-Windows.zip`. Final source/package identity is in VERSION.txt and Docs/CR097-100/package-final-verification.json. See [actual validation and failures](Docs/CR097-100/VALIDATION.md), [implementation](Docs/CR097-100/IMPLEMENTATION.md), and [concise Dan checklist](Docs/CR097-100/README-player.txt). Summit flights clear the crest for 4.00–5.74 seconds but still receive zero score for hard landings. Map/exploration and other unreviewed systems remain awaiting further testing. No physical Deck/controller or subjective listening claim.
