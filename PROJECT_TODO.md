...
**Consistent testing entry point:** Dan launches `Play-Racer.cmd` at the project root, or `Builds/Latest/Racer.exe`. After each new validated playable build, update the complete `Builds/Latest` runtime folder (including VERSION.txt); never replace only its executable. Keep older versioned builds separately. Current combined review build is 0.6.3-review1; Builds/Latest/VERSION.txt records its source. BUG-004/008 and CR-046–049 are implemented awaiting Dan review; technical validation does not close the earlier human reports. See Docs/CR046-049/VALIDATION.md and its short combined playtest checklist. A source commit alone does not update a compiled player.
...
**Status:** AUTHORIZED — next integrated delivery with CR-050 through CR-054.
...
**Status:** AUTHORIZED — next integrated delivery.
