...
**Status:** IMPLEMENTED — awaiting Dan review in 0.11.0-review1 on both courses. Keyboard/controller checks use emulated devices; physical-controller acceptance remains pending.
